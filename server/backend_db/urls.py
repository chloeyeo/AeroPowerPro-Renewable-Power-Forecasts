...
from backend_db.views import UserView, get_elexon, get_elexon_by_date, register_view, GeolocationsView, HistoricWindViewSet, PowerForecastViewSet, PowerForecastByAreaViewSet
...
urlpatterns = [
    ...
    path('power_forecast_by_area/', PowerForecastByAreaViewSet.as_view(), name = "power_forecast_by_area"),
    # re_path('^',include(router.urls)),
]